...
// ================= COLORS =================
const Color kPrimary = Color(0xFF5B5FEF);
                ...
                : SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _infoTile(Icons.badge_outlined, "Roll Number",
                            user.rollNumber ?? ""),

                        const SizedBox(height: 12),

                        _infoTile(Icons.person_outline, "Father Name",
                            user.fatherName ?? ""),

                        const SizedBox(height: 12),

                        _infoTile(Icons.credit_card, "CNIC",
                            user.cnic ?? ""),
                        ...
                        _infoTile(Icons.school_outlined, "Department",
                            user.department ?? ""),

                        const SizedBox(height: 12),

                        _infoTile(Icons.calendar_month_outlined, "Semester",
                            user.semester ?? ""),

                        const SizedBox(height: 12),

                        _infoTile(Icons.group, "Section",
                            user.section ?? ""),
...
class ProfileShimmer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: [
        ...
        ...List.generate(6, (_) => _shimmerTile()),
  ...
  Widget _shimmerTile() {
    return Padding(
      padding: const EdgeInsets.only(bottom: 12),
      child: _shimmerBox(height: 70, radius: 20),
    );
  }

  Widget _shimmerLine({double width = double.infinity}) {
    return _shimmerBox(height: 14, width: width, radius: 8);
  }

  Widget _shimmerBox(
      {double height = 100, double width = double.infinity, double radius = 12}) {
...
//   static const Color borderColor = Color(0xFFE9E6F2);
//   static const Color fieldBg = Color(0xFFF7F5FC);
...
//                           _ProfileField(
//                             label: 'Email',
//                             value: 'rehamh02@gmail.com',
//                             editable: true,
//                           ),
//                           SizedBox(height: 8),
//                           _ProfileField(
//                             label: 'Semester / Section',
//                             value: '5th Semester - B',
//                             editable: true,
//                           ),
//                         ],
//                       ),
...
//                 size: 18,
//                 color: editable ? accent : const Color(0xFF9A94B8),
//               ),
//             ],
//           ),
//         ),
