      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            TextFormField(initialValue: courseTitle, readOnly: true, style: const TextStyle(fontWeight: FontWeight.bold, color: Color(0xFF4F46E5)), decoration: InputDecoration(labelText: "Locked Subject Domain", prefixIcon: const Icon(Icons.school, color: Color(0xFF4F46E5)), filled: true, fillColor: const Color(0xFF4F46E5).withOpacity(0.05), border: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide(color: const Color(0xFF4F46E5).withOpacity(0.3))))),
            const SizedBox(height: 20),
            ...
            const SizedBox(height: 16),
            DropdownButtonFormField<String>(value: difficulty, decoration: InputDecoration(labelText: "Difficulty Level", border: OutlineInputBorder(borderRadius: BorderRadius.circular(10))), items: ["Easy", "Medium", "Hard"].map((d) => DropdownMenuItem(value: d, child: Text(d))).toList(), onChanged: (val) => setState(() => difficulty = val ?? "Medium")),
